...
export const PRESET_VOCABULARIES = {
  ...
  "space-station": {
    ...
    structures: [
      ...
      { id: "sealed-section", label: "Sealed section", wall: "sealed-bulkhead", floor: "corridor", door: null, minSize: 3, maxSize: 3, minCount: 0, maxCount: 1 },
    ],
    elements: [
      ground("corridor", "Corridor", "A metal walkway joining the station's sections.", "The most common cell. Forms continuous lines that connect every room. Never isolated.", "metal-floor", { zone: "outdoor" }),
      ...
      thing("cargo-crate", "Cargo crate", "A sealed supply crate with a manifest tag.", "Uncommon. On the hangar deck or against a corridor wall, in pairs.", "crate", ["contents", "manifestId", "sealed"], true, { zone: "any", onlyNext: ["hangar-floor", "corridor", "cargo-crate", "bulkhead"] }),
      thing("maintenance-bot", "Maintenance bot", "A squat robot polishing the deck.", "Rare. In a corridor, never next to a crew member.", "robot", ["task", "batteryLevel", "chattiness"], true, { zone: "outdoor", onlyNext: ["corridor"], neverNext: ["crew-member", "maintenance-bot"] }),
  ...
  "cyberpunk-block": {
    ...
    elements: [
      ground("street", "Wet street", "Asphalt shining under the neon.", "The most common cell. Forms wide straight lines through the block. Never isolated.", "road", { zone: "outdoor" }),
      ground("sidewalk", "Sidewalk", "Cracked concrete with puddles.", "Common. Lines both sides of every street. Never two cells deep.", "pavement", { zone: "outdoor", onlyNext: ["street", "sidewalk", "tower-wall", "tower-door", "noodle-bar", "vending-machine", "pedestrian", "car"] }),
      ...
      thing("security-drone", "Security drone", "A hovering corporate drone with a red eye.", "Rare. Over a street or a sidewalk, never in an alley, never two adjacent.", "robot", ["corporation", "alertLevel", "armed"], true, { zone: "outdoor", onlyNext: ["street", "sidewalk"], neverNext: ["security-drone", "alley"] }),
      ...
      thing("pedestrian", "Pedestrian", "Somebody hurrying through the rain.", "Uncommon. On a sidewalk or crossing a street. Never next to another pedestrian.", "person", ["name", "job", "augmentations", "mood"], true, { zone: "outdoor", onlyNext: ["sidewalk", "street"], neverNext: ["pedestrian"] }),
