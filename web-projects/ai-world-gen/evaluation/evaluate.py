...
not set). AI_WORLD_GEN_GENERATION=whole-map makes every map one call to the
narrative model instead of a decision per cell (`wholeMap.js`); the mode is
recorded in the version's description and in the results file.
