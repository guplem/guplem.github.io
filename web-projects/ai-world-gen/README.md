...
- **Download the picture**: **Download PNG** saves the whole map as an image in the style on screen, edge to edge. The zoom, the pan, the frames and the corner marks stay out of the file, so it is the map and not a screenshot.
