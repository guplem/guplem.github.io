...
- **Statistics page** — a dedicated page (linked from the stats card) that charts your wins, losses and ties over time with a hand-drawn **SVG line chart** (no charting library), a companion **prediction-confidence-over-time** chart showing how sure the AI was each round, plus win rate, recent form, best/worst streaks, and a breakdown of how predictable your move choices have been.
