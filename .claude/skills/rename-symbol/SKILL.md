...
- **Persisted keys are storage, not just code.** localStorage keys in web-projects hold real user data (root ADR 0009); renaming the code symbol is safe, but renaming the stored key breaks existing data and needs an explicit migration.
