# ADR 0001: Custom Statistical Predictor Instead of an ML Library (RPS Mind Reader)
...
- Zero runtime dependencies; aligns with root ADR 0002 (no build) and root ADR 0005 (no unnecessary CDN deps). Works fully offline.
...
- It is a bespoke algorithm to understand and maintain rather than an off-the-shelf model. This is mitigated by tests, the benchmark, and this ADR.
